...
*/
odoo.define('web_widget_image_webcam_portrait.webcam_widget', function(require) {
    "use strict";
    ...
    FieldBinaryImage.include({
        ...
        _render: function () {
            ...
            Webcam.set({
                ...
                //force_flash: false,
                //fps: 45,
                //swfURL: '/web_widget_image_webcam_portrait/static/src/js/webcam.swf',
                constraints: {
                    width: 315,
                    height: 417,
                }
            ...
            self.$el.find('.o_form_binary_file_web_cam').off().on('click', function(){
                ...
                dialog.opened().then(function() {
                    ...
                    WebCamDialog.find("#webcam_result").html('<img src="/web_widget_image_webcam_portrait/static/src/img/webcam_placeholder.png"/>');
                });
            });
        },
    });
