...
class EdiConfigSystem(models.Model):
    ...
    customer_code = fields.Char(
        string="Customer code", default="33513", required=True
    )
    constant_file_start = fields.Char(
        string="Constant file start", default="HDIAPAR ", required=True
    )
    constant_file_end = fields.Char(
        string="Constant file end", default="*DIAPAR*DIAPAR", required=True
    )
    ...
    ftp_password = fields.Char(
        string="FTP Password", default="divers", required=True
    )
