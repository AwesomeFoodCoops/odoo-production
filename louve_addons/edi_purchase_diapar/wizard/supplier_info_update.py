...
class SupplierInfoUpdate(models.TransientModel):
    ...
    def update_prices_edi(self, lines, active_model, seller_values_lines, supplier, edi_supplier):
        ...
        if supplier.is_edi:
            ...
            for seller_values in seller_values_lines:
                ...
                edi_price = self.env['supplier.price.list'].search([('supplier_id', '=', edi_supplier.id),
    ...
    def compute_process_lines(self, active_model, active_obj):
        ...
        """
        lines = super(SupplierInfoUpdate, self).compute_process_lines(active_model, active_obj)
